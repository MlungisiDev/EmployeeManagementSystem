...
namespace EmployeeMngmentSystem
{
    public partial class Salaries : Form
    {
        ...
        private void GetSalary()
        {
            ...
            if(DaysTb.Text == "")
            {
                AmountTb.Text = "R " + (m * DSal);
            }else if(Convert.ToInt32(DaysTb.Text) > 31)
            {
                MessageBox.Show("Days Cannot Be Grreater Than 31");
            }
            else
            {
                m = Convert.ToInt32(DaysTb.Text);
                AmountTb.Text = "R " + (m * DSal);
            }
        ...
        private void ShowSalaries()
        {
            try
            {
                string Query = "Select * from SalariesTbl";
        ...
        private void AddBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string Query = "insert into SalariesTbl values({0},{1},'{2}',{3},'{4}')";
